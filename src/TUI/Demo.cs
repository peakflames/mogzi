...
public static class Demo
{
    public static void ShowCards()
    {
        ...
        AnsiConsole.Write(runningCommand.Render());
        AnsiConsole.WriteLine();
        ...
        AnsiConsole.Write(successCommand.Render());
        AnsiConsole.WriteLine();
        ...
        AnsiConsole.Write(errorCommand.Render());
        AnsiConsole.WriteLine();
        ...
        AnsiConsole.Write(richContentCard.Render());
        AnsiConsole.WriteLine();
        ...
        AnsiConsole.Write(activeApi.Render());
        AnsiConsole.WriteLine();
        ...
        AnsiConsole.Write(completedApi.Render());
        AnsiConsole.WriteLine();
