...
public sealed class LegacyFlexColumnTuiApp : IDisposable
{
    ...
    public LegacyFlexColumnTuiApp(IServiceProvider serviceProvider)
    {
...
#pragma warning restore IDE0010 // Add missing cases
    ...
    private void NavigateAutocomplete(bool up)
    {
        ...
        _inputContext.SelectedSuggestionIndex = up
