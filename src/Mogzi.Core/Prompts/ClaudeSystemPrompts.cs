...
- When you want to modify a file, use the apply_code_patch, replace_in_file or write_to_file tool directly with the desired changes. You do not need to display the changes before using the tool.
