...
- [Microsoft.Extensions.AI libraries](#microsoftextensionsai-libraries)
  - [The packages](#the-packages)
    - [Which package to reference](#which-package-to-reference)
  ...
  - [See also in this local workspace](#see-also-in-this-local-workspace)
...
## See also in this local workspace

- docs\llmctx\Microsoft.Extensions.AI.Abstractions.md
- docs\llmctx\Microsoft.Extensions.AI.md
- docs\llmctx\Microsoft.Extensions.AI.OpenAI.md
