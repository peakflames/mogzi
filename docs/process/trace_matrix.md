...
|--------|-------------|-------------------|--------------------------|------------|-------------------|
| TOR-1.1 | AI code analysis and generation | [All tool specs](05_ai_tool_op_requirements.md) | `Cli.App`, `MaxBot.ChatClient`, `MaxBot.Tools.FileSystemTools`, `MaxBot.Tools.SystemTools` | `test/Cli.Tests/BlackBoxTests.cs`, `test/local_exe_acceptance.ps1`, `test/MaxBot.Tests/Tools/FileSystemToolTests.cs` | ✅ Verified |
...
| TOR-3.3 | Permission respect | [All file tools](05_ai_tool_op_requirements.md) | `MaxBot.Tools.FileSystemTools` with read-only file attribute checks | `test/MaxBot.Tests/Tools/FileSystemToolTests.cs` | ✅ Verified |

### TOR-4: Development Environment Integration

| TOR ID | Requirement | Tool Specifications | Implementation Components | Test Cases | Verification Status |
|--------|-------------|-------------------|--------------------------|------------|-------------------|
| TOR-4.1 | MaxBot integration | [All tool specs](05_ai_tool_op_requirements.md) | `Cli.Program`, `Cli.App`, `MaxBot.Services.AppService` | `test/local_exe_acceptance.ps1`, `test/Cli.Tests/BlackBoxTests.cs` | ✅ Verified |
...
| TOR ID | Requirement | Tool Specifications | Implementation Components | Test Cases | Verification Status |
|--------|-------------|-------------------|--------------------------|------------|-------------------|
| TOR-5.1 | Iterative execution | [All tool specs](05_ai_tool_op_requirements.md) | `Cli.App` (Chat Mode), `MaxBot.Services.AppService` | `test/Cli.Tests/BlackBoxTests.cs` | ✅ Verified |
...
| TOR ID | Requirement | Tool Specifications | Implementation Components | Test Cases | Verification Status |
|--------|-------------|-------------------|--------------------------|------------|-------------------|
| TOR-7.1 | Approval for destructive ops | [All file tools](05_ai_tool_op_requirements.md), [execute_command_tool_spec.md](tools/execute_command_tool_spec.md) | `MaxbotConfiguration.ToolApprovals`, `CliArgParser`, `MaxBot.Tools.SystemTools.ExecuteCommand`, `MaxBot.Tools.FileSystemTools` | `test/Cli.Tests/CliArgParserTests.cs`, `test/MaxBot.Tests/Tools/SystemToolTests.cs`, `test/Cli.Tests/BlackBoxTests.cs` | ✅ Verified |
| TOR-7.2 | Working directory constraints | [All file tools](05_ai_tool_op_requirements.md) | FileSystemTools.IsPathInWorkingDirectory() with path validation | test/MaxBot.Tests/Tools/FileSystemToolTests.cs | ✅ Verified |
| TOR-7.3 | Input/output validation | [All tool specs](05_ai_tool_op_requirements.md) | Partially implemented via error handling and input validation | test/MaxBot.Tests/Tools/FileSystemToolTests.cs, test/MaxBot.Tests/Tools/SystemToolTests.cs | 🟡 Partially Verified |
...
| TOR-8.2 | Graceful error handling | [All tool specs](05_ai_tool_op_requirements.md) | `Cli.App`, `MaxBot.Tools.SystemTools`, `MaxBot.Tools.FileSystemTools`, comprehensive try-catch blocks | `test/Cli.Tests/BlackBoxTests.cs`, `test/MaxBot.Tests/Tools/SystemToolTests.cs`, `test/MaxBot.Tests/Tools/FileSystemToolTests.cs` | ✅ Verified |
